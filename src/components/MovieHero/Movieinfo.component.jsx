...
const Movieinfo = () => {
    return (
        ...
        <div className="flex flex-col gap-3 lg:gap-8">
            ...
            <h1 className=" hidden lg:block text-white lg:text-5xl ">R A D I O A C T I V E</h1>
           ...
           <div className="flex flex-col-reverse gap-3 lg:gap-5 lg:flex-col">
            ...
            <div className="text-white font-light flex flex-col gap-3 md:px-4">
                    <h4 className="">4K &bull; English &bull; Action</h4>
                    <h4 className="">4h 3m &bull; Action, Sci-fi, Thriller &bull; 13+</h4>
            </div>
